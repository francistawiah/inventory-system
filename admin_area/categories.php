      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="modal-content" style="height:auto">
            ...
            <form class="form-horizontal" method="post" action="cat-update.php" enctype='multipart/form-data'>
            ...
            <div class="form-group">
              <label class="control-label col-lg-3">Category Status</label>
              <div class="col-lg-9">
              <input type="hidden" class="form-control" name="cat_id" value="<?php echo $cat_id; ?>" required>  
       ...
       <div id="delete<?php echo $cat_id; ?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        ...
        <div class="modal-content" style="height:auto">
         ...
         <div class="modal-body">
          <form class="form-horizontal" method="post" action="cat-del.php">
             
          <input type="hidden" class="form-control" name="cat_id" value="<?php echo $cat_id; ?>" required> 
                      
          <p>Are you sure you want to <b>Delete</b> this Product Category?</p>
...
<?php include("includes/footer.php"); ?>
         ...
         <div id="add" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
          ...
          <div class="modal-content" style="height:auto">
            ...
            <form class="form-horizontal" method="post" action="cat-add.php" enctype='multipart/form-data'>
