	      ...
	      <div class="col-md-9">
              <div class="box box-primary">
                <div class="box-header">
				  ...
				  <!--<a href="#scan" data-target="#scan" data-toggle="modal" style="color:#fff;" class="small-box-footer"><button class="btn btn-lg btn-primary" type="" name="">Scan</button></a>-->
                </div>
                <div class="box-body">
                  <!-- Date range -->
...
<?php }?>					  
        ...
        <button class="btn btn-lg btn-block btn-primary" id="daterange-btn" name="cash" type="submit" tabindex="7"> Complete Sales </button>
		<button class="btn btn-lg btn-block" id="daterange-btn" tabindex="8">
        <a href="home.php">Cancel Sale</a>
        </button>
