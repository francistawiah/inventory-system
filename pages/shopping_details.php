        ...
        <div class="container">
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active">Customer Shopping Details</li>
            </ol>
          </section>
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    ?>
                     ...
                     <a href="shopping_details.php" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-th text-green"></i></a>
            						</td>
                  </tr>
