...
<?php
   // $cid=$_REQUEST['cid'];
    $query1=mysqli_query($con,"select * from sales natural join sales_details natural join product where modeofpayment='cash' order by date_added desc")or die(mysqli_error($con));
    while($row1=mysqli_fetch_array($query1)){
