...
?>
            ...
            <td class="record"><?php echo $row['prod_name'];?></td>
                        ...
                        <td>
							...
							<a href="#updateTemp<?php echo $row['temp_trans_id'];?>" data-target="#updateTemp<?php echo $row['temp_trans_id'];?>" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-edit text-blue"></i></a>
              ...
              <a href="#delete<?php echo $row['temp_trans_id'];?>" data-target="#delete<?php echo $row['temp_trans_id'];?>" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-trash text-red"></i></a>
					  ...
					  <div id="updateTemp<?php echo $row['temp_trans_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
					 ...
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Total</label>
							  <input type="hidden" class="form-control" name="cid" value="₵<?php echo $cid;?>" required>    
                <input type="text" style="text-align:right" class="form-control" id="total" name="total" placeholder="Total" value="₵<?php echo number_format($grand,2);?>" tabindex="5" readonly>
						  </div><!-- /.form group -->
					</div>
				</div>	
               
                  
          <button class="btn btn-lg btn-block btn-primary" id="daterange-btn" name="credit" type="submit" tabindex="7"> Complete Credit </button>
          <a href="cash_transaction.php" class="btn btn-default btn-lg btn-block">Cancel Sale</a>
