...
include('../dist/includes/dbcon.php');
	...
	$query2=mysqli_query($con,"select * from customer where cust_last='$last' and cust_first='$first' and branch_id='$branch'")or die(mysqli_error($con));
		...
		{	
			...
			mysqli_query($con,"INSERT INTO customer(cust_last,cust_first,cust_address,cust_contact,branch_id,balance) 
				VALUES('$last','$first','$address','$contact','$branch','0')")or die(mysqli_error($con));
