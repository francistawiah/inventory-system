...
include('../dist/includes/dbcon.php');
	...
	mysqli_query($con,"INSERT INTO stockin(prod_id,supplier_id, brand_id, qty, cost_per_product, date, branch_id)VALUES('$name','$supplier_name', '$brand_name',  '$qty', '$cost_per_product', NOW(),'$branch')")or die(mysqli_error($con));

	echo "<script>alert('Successfully added new stock!');</script>";
