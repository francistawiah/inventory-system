...
<html>
  <head>
    ...
    <title>Credit | <?php include('../dist/includes/title.php');?></title>
...
<?php }?>			
          ...
          <button class="btn btn-lg btn-block btn-success" id="daterange-btn" name="finish" type="submit" tabindex="7"> Finish </button>
				</form>	
          </div><!-- /.box-body -->
            </div><!-- /.box -->
             </div><!-- /.col (right) -->
