                    ...
                    <form method="POST" action="income.php">
                      ...
                      <div class="col-lg-4 col-xs-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="submit"  name="btn_calculate" class="btn-back btn-block" value="Calculate Profit" required>
                        </div>
                        </div>

                        <div class="form-group">
                          <div class="col-lg-4 col-xs-6" style="padding-top: 50px; margin-bottom: 35px;">
                          <input type="submit" name="btn_income" class="btn-back btn-block" value="Save Profit" required>
                        </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-xs-6" style="margin-left: 150px; margin-bottom: 35px;">
                          <a href="view.php">
                            <button type="submit" class="btn-back btn-block">View Profit</button>
                        ...
                        <input type="reset" name="clear_income" class="btn-back btn-block" value="Clear">
                        </div>
                        </div>
