        ...
        <div class="container">
		  ...
		  ?>	
		    <img class = "profile_pic" src = "../dist/uploads/<?php echo $row['cust_pic'];?>">
                 ...
                 <a href="#" data-target="#updatereg" data-toggle="modal" class="btn btn-block btn-warning"><i class="glyphicon glyphicon-plus-sign text-blue"></i>Add Payment</a>
				          </form>	
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col (right) -->
...
?>    
              <div id="updatereg" class="modal fade in primary" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
