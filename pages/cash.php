    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <form method="post" name="autoSumForm" action="sales_add.php">
            ...
            <!--  <br /><b>Notice</b>:  Undefined variable: grand in <b>C:\xampp\htdocs\inventory\Inventory\pages\cash.php</b> on line <b>125</b><br />0.00 -->
						  ...
						  <div class="form-group">
							...
							<div class="input-group">
								<input type="text" class="form-control" id="date" name="discount" value="0" tabindex="6" placeholder="Discount" onFocus="startCalc();" onBlur="stopCalc();>
							</div><!-- /.input group -->
						  </div><!-- /.form group -->
						  <div class="form-group">
          ...
          <div class="form-group col-md-12">
            <button class="btn btn-lg btn-block btn-primary" id="daterange-btn" name="" type="submit"  tabindex="7"> Complete Sales </button>
